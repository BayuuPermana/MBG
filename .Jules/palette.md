...
## 2025-12-14 - Icon Button Accessibility
**Learning:** Icon-only buttons (ghost variant) lack accessible names for screen readers.
**Action:** Always add `aria-label` describing the action (e.g., "Edit user") to buttons with `size="icon"`.
